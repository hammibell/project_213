...
def car_control():
    ...
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam))
    time.sleep(6)
    dropped_vehicle.apply_control(carla.VehicleContrl(throttle = 0.7, steer = 1))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam | carla.VehicleLightState.RightBlinker))
    time.sleep(5)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.35))
    dropped_vehicle.set_light_State(carla.VehicleLIghtState(Carla.VehicleLightState.All))
    time.sleep(5)
